  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: Color(0xFFFD5D69)),
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
        backgroundColor: _activeTab == title
            ? Color(0xFFFFC6C9) // Highlighted background for active tab
            : Colors.white,
      ...
      child: Text(
        ...
        style: TextStyle(
          color: _activeTab == title
              ? Color(0xFFFD5D69) // Highlighted text color for active tab
