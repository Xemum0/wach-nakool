...
Widget Suggestions(String image, String text, String description, String stars, String time) {
  return Column(
    children: [
      Stack(
        children: [
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text(
                text,
                style: const TextStyle(fontSize: 16), // Smaller font size for tighter layout
              ),
            ),
            Padding(
              padding: const EdgeInsets.fromLTRB(8, 0, 8, 0), // Reduced padding
                    ...
                    Padding(
                      ...
                      child: Text(
                        ...
                        style: const TextStyle(
                            fontSize: 14, color: Color.fromRGBO(253, 93, 105, 1)),
                      ),
                    ),
                  ],
                ),
